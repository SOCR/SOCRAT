...
(function() {
  'use strict';
  var BaseService, DatabaseDataAdaptor,
  ...
  module.exports = DatabaseDataAdaptor = (function(superClass) {
    extend(DatabaseDataAdaptor, superClass);

    function DatabaseDataAdaptor() {
      return DatabaseDataAdaptor.__super__.constructor.apply(this, arguments);
    }

    DatabaseDataAdaptor.inject('app_analysis_database_msgService');

    DatabaseDataAdaptor.prototype.initialize = function() {
      this.eventManager = this.app_analysis_database_msgService;
      return this.DATA_TYPES = this.eventManager.getSupportedDataTypes();
    };

    DatabaseDataAdaptor.prototype.toDvTable = function(dataFrame) {
    ...
    DatabaseDataAdaptor.prototype.toDataFrame = function(table) {
    ...
    return DatabaseDataAdaptor;

  })(BaseService);

}).call(this);

//# sourceMappingURL=DatabaseDataAdaptor.service.js.map
