...
(function() {
  ...
  module.exports = MyModuleSidebarCtrl = (function(superClass) {
    ...
    MyModuleSidebarCtrl.inject('app_analysis_mymodule_dataService', 'app_analysis_mymodule_msgService', 'app_analysis_mymodule_algorithms', '$scope', '$timeout');

    MyModuleSidebarCtrl.prototype.initialize = function() {
      this.dataService = app_analysis_mymodule_dataService;
      this.msgService = app_analysis_mymodule_msgService;
      this.algorithmsService = this.app_analysis_mymodule_algorithms;
    ...
    MyModuleSidebarCtrl.prototype.updateAlgControls = function() {
      return this.algParams = this.algorithmsService.getParamsByName(this.selectedAlgorithm);
    };

    MyModuleSidebarCtrl.prototype.updateDataPoints = function(data, means, labels) {
      var row, xCol, yCol;
      if (data == null) {
        data = null;
      }
      ...
      return this.msgService.broadcast('MyModule:updateDataPoints', {
        dataPoints: data,
        means: means,
        labels: labels
      });
    ...
    MyModuleSidebarCtrl.prototype.updateSidebarControls = function(data) {
    ...
    MyModuleSidebarCtrl.prototype.uniqueVals = function(arr) {
      return arr.filter(function(x, i, a) {
        return i === a.indexOf(x);
      });
    };

    MyModuleSidebarCtrl.prototype.detectK = function() {
      var detectedK;
      detectedK = this.detectKValue();
      return this.setDetectedKValue(detectedK);
    };

    MyModuleSidebarCtrl.prototype.setDetectedKValue = function(detectedK) {
      if (detectedK.num <= 10) {
    ...
    MyModuleSidebarCtrl.prototype.detectKValue = function() {
    ...
    MyModuleSidebarCtrl.prototype.prepareData = function() {
    ...
    MyModuleSidebarCtrl.prototype.parseData = function(data) {
    ...
    MyModuleSidebarCtrl.prototype.runClustering = function() {
      var clustData, res;
    ...
    MyModuleSidebarCtrl.prototype.stepClustering = function() {
    ...
    MyModuleSidebarCtrl.prototype.reset = function() {
...
//# sourceMappingURL=MyModuleSidebarCtrl.js.map
