...
module.exports = class StatisticDataService extends BaseModuleDataService
  @inject '$q', 'app_analysis_statistic_msgService'

  # requires renaming message service injection to @msgService
  initialize: () ->
    @msgManager = @app_analysis_statistic_msgService
