...
(function() {
  'use strict';
  var BaseDirective, ClusterVizDir,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

  BaseDirective = require('scripts/BaseClasses/BaseDirective');

  module.exports = ClusterVizDir = (function(superClass) {
    extend(ClusterVizDir, superClass);

    function ClusterVizDir() {
      return ClusterVizDir.__super__.constructor.apply(this, arguments);
    }

    ClusterVizDir.inject('$parse');

    ClusterVizDir.prototype.initialize = function() {
      this.restrict = 'E';
...
//# sourceMappingURL=ClusterVizDir.directive.js.map
