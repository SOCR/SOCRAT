...
module.exports = class DimensionReductionDataService extends BaseModuleDataService
  @inject '$q', 'app_analysis_dimension_reduction_msgService'

  # requires renaming message service injection to @msgService
  initialize: () ->
    @msgManager = @app_analysis_dimension_reduction_msgService
