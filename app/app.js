...
(function() {
  'use strict';
  var $, AppConfig, ModuleList, appConfig, bodyTemplate, core, moduleList;
  ...
  angular.module('app', moduleList.listAll()).config(appConfig.getConfigBlock()).run(appConfig.getRunBlock());
